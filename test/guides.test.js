 ...
 * reads 137,361, which is 0.92, and is `src/linters/`'s once more. What
 ...
 * stands over it — 25,696 for `src/linters/CLAUDE.md`, where half of the bar
 ...
 * 2,639 characters of headroom, off a chain that is `src/linters/`'s own once
 ...
 * of this file behind it, 6,190 characters out of every chain through `test/`
