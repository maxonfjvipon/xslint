 ...
 * reads 136,603, which is 0.91, and is `src/linters/`'s once more. What
 ...
 * stands over it — 26,454 for `src/linters/CLAUDE.md`, where half of the bar
 ...
 * 3,397 characters of headroom, off a chain that is `src/linters/`'s own once
 ...
 * of this file behind it, 6,948 characters out of every chain through `test/`
