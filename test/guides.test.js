 ...
 * reads 137,427, which is 0.92, and is `src/linters/`'s once more. What
 ...
 * stands over it — 25,630 for `src/linters/CLAUDE.md`, where half of the bar
 ...
 * 2,573 characters of headroom, off a chain that is `src/linters/`'s own once
 ...
 * of this file behind it, 6,124 characters out of every chain through `test/`
