 ...
 * reads 137,158, which is 0.91, and is `src/linters/`'s once more. What
 ...
 * stands over it — 25,899 for `src/linters/CLAUDE.md`, where half of the bar
 ...
 * 2,842 characters of headroom, off a chain that is `src/linters/`'s own once
 ...
 * of this file behind it, 6,393 characters out of every chain through `test/`
