 ...
 * reads 138,565, which is 0.92, and is `src/linters/`'s once more. What
 ...
 * is 75,000 — and holds the root itself to 84,786, a number derived from the
 ...
 * 1,435 characters of headroom, off a chain that is `src/linters/`'s own once
