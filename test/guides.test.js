 ...
 * reads 138,053, which is 0.92, and is `src/linters/`'s once more. What
 ...
 * stands over it — 25,004 for `src/linters/CLAUDE.md`, where half of the bar
 ...
 * 1,947 characters of headroom, off a chain that is `src/linters/`'s own once
 ...
 * of this file behind it, 5,498 characters out of every chain through `test/`
