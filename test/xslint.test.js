...
const {runXslint, runXslintWithExcludes} = require('./helpers')
...
describe('xslint', function() {
  ...
  it('should print less violations in xsl file', function() {
    const stdout = runXslintWithExcludes(['test/resources/xsl-packs/xsl-with-some-violations.xsl'], ['empty-content-in-instructions','template-match-starts-with-double-slash'])
    const expected = [
